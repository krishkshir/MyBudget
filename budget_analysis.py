...
def main(a_tx_file, a_period="Test period",
    ...
    inc, exp, sav = read_tx_file(a_tx_file)
    ...
    write_reports(a_report_file, a_period, grp_inc, grp_exp, grp_sav,
            a_summary_file)
    ...
    plot_tallied_tx(grp_sav, "Savings", "Plot_Savings_" + a_period + ".png")
# enddef main() #
